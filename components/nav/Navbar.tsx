...
export function Navbar() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 px-6 md:px-12 py-4 md:py-[22px] z-[100] md:mix-blend-multiply bg-background/95 backdrop-blur-md border-b border-foreground/[0.05] md:border-none md:bg-transparent md:backdrop-blur-none transition-all duration-300">
